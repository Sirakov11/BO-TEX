      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8 lg:px-12 py-20 md:py-32 w-full">
        <div className="grid md:grid-cols-5 gap-12 items-center">
          <div className="md:col-span-3 text-left">
            <div className="w-20 h-1 bg-primary mb-6 transform -rotate-2" />
            <p className="text-primary text-xl md:text-2xl mb-4 font-semibold">
              Вашият надежден партньор от 2009
            </p>
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-display font-bold text-secondary-foreground mb-6 tracking-tight">
              BO-TEX
            </h1>
