...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-secondary/95 backdrop-blur-md shadow-md border-b border-secondary-foreground/10">
      <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
        <div className="flex items-center justify-between h-16 gap-4">
          <button
            onClick={() => scrollToSection("#hero")}
            className="flex-shrink-0 hover-elevate active-elevate-2 rounded-lg bg-white px-3 py-1.5 shadow-sm"
